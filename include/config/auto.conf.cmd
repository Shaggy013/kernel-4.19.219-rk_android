...
ifneq "$(CC_VERSION_TEXT)" "Android (6573524 based on r383902b) clang version 11.0.2 (https://android.googlesource.com/toolchain/llvm-project b397f81060ce6d701042b782172ed13bee898b79)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "../prebuilts/clang/host/linux-x86/clang-r383902b/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "../prebuilts/clang/host/linux-x86/clang-r383902b/bin/ld.lld"
include/config/auto.conf: FORCE
endif
...
ifneq "$(CLANG_FLAGS)" " --target=aarch64-linux-gnu --prefix=./../prebuilts/gcc/linux-x86/aarch64/gcc-linaro-6.3.1-2017.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu- --gcc-toolchain=/home/thc013/corner/quartz-v/prebuilts/gcc/linux-x86/aarch64/gcc-linaro-6.3.1-2017.05-x86_64_aarch64-linux-gnu -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
